...
local profile = t_utils.get_profile_definition("smoke_v1.yaml")
...
test.register_message_test(
  "smoke - From zigbee (detected)",
  {
    ...
    },
    {
      channel = "capability",
      direction = "send",
      message = mock_parent_device:generate_test_message("main", capabilities.smokeDetector.smoke.detected())
    },
  }, {
    test_init = test_init_parent
  }
...
test.register_message_test(
  "smoke - From zigbee (clear)",
  {
    ...
    },
    {
      channel = "capability",
      direction = "send",
      message = mock_parent_device:generate_test_message("main", capabilities.smokeDetector.smoke.clear())
    },
  }, {
    test_init = test_init_parent
  }
