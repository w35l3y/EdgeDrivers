...
local mock_parent_device = test.mock_device.build_test_zigbee_device({
  profile = t_utils.get_profile_definition("dimmer_v1.yaml"),
  zigbee_endpoints = {
    [1] = {
      id = 1,
      manufacturer = "mfr",
...
local mock_first_child = test.mock_device.build_test_child_device({
  profile = t_utils.get_profile_definition("child_dimmer_v1.yaml"),
