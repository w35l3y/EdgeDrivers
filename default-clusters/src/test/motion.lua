...
local profile = t_utils.get_profile_definition("motion_v1.yaml")
...
test.register_message_test(
  "motion - From zigbee (active)",
  {
    ...
    },
    {
      channel = "capability",
      direction = "send",
      message = mock_parent_device:generate_test_message("main", capabilities.motionSensor.motion.active())
    },
  }, {
    test_init = test_init_parent
  }
...
test.register_message_test(
  "motion - From zigbee (inactive)",
  {
    ...
    },
    {
      channel = "capability",
      direction = "send",
      message = mock_parent_device:generate_test_message("main", capabilities.motionSensor.motion.inactive())
    },
  }, {
    test_init = test_init_parent
  }
