...
local profile = t_utils.get_profile_definition("contact_v1.yaml")
...
test.register_message_test(
  "contact - From zigbee (open)",
  {
    ...
    },
    {
      channel = "capability",
      direction = "send",
      message = mock_parent_device:generate_test_message("main", capabilities.contactSensor.contact.open())
    },
  }, {
    test_init = test_init_parent
  }
