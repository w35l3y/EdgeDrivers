...
-- local tuya_types = require "st.zigbee.generated.zcl_clusters.TuyaE001.types"
...
function TuyaCommand.build_test_rx(device, command)
  ...
  setmetatable(out, {__index = TuyaCommand})
  out:set_field_names()
  return TuyaCommand._cluster:build_test_rx_cluster_specific_command(device, out, "client")
end
