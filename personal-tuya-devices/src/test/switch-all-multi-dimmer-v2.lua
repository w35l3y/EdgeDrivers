...
local profile = t_utils.get_profile_definition("switch-all-multi-dimmer-v2.yaml")
...
local test_init_mod = function ()
  ...
  test.socket.device_lifecycle:__queue_receive(mock_parent_device:generate_info_changed({preferences = {
    profile = "switch_all_multi_dimmer_v2",
    rate = 500,
...
test.register_message_test(
  "To zigbee (switch all)",
  {
    ...
    },
    {
      channel = "zigbee",
      direction = "send",
      message = { mock_parent_device.id, zcl_clusters.TuyaEF00.commands.DataRequest(mock_parent_device, { { 1, data_types.Boolean(true) }, { 7, data_types.Boolean(true) } }) }
    },
    -- {
    --   channel = "zigbee",
    --   direction = "send",
...
test.register_message_test(
  "To zigbee (dimmer all)",
  {
    ...
    },
    {
      channel = "zigbee",
      direction = "send",
      message = { mock_parent_device.id, zcl_clusters.TuyaEF00.commands.DataRequest(mock_parent_device, { { 2, tuya_types.Int32(500) }, { 8, tuya_types.Int32(500) } }) }
    },
    -- {
    --   channel = "zigbee",
    --   direction = "send",
    --   message = { mock_parent_device.id, zcl_clusters.TuyaEF00.commands.DataRequest(mock_parent_device, { { 8, tuya_types.Int32(500) } }) }
    -- },
  }, {
    test_init = test_init
  }
  ...
  {
    {
      channel = "zigbee",
      direction = "receive",
      message = { mock_parent_device.id, zcl_clusters.TuyaEF00.commands.DataReport:build_test_rx(mock_parent_device, { { 2, tuya_types.Int32(1000) } }) }
    },
    {
      channel = "capability",
      direction = "send",
      message = mock_parent_device:generate_test_message("main01", capabilities.switchLevel.level(100))
    },
  }, {
    test_init = test_init
  }
  ...
  {
    {
      channel = "capability",
      direction = "receive",
      message = { mock_parent_device.id, { capability = "switchLevel", component = "main01", command = "setLevel", args = { 50 } } },
    },
    {
      channel = "zigbee",
      direction = "send",
      message = { mock_parent_device.id, zcl_clusters.TuyaEF00.commands.DataRequest(mock_parent_device, { { 2, tuya_types.Int32(500) } }) }
    },
  }, {
    test_init = test_init
  }
...
test.register_message_test(
  "From zigbee (DP 1) - switch (mod)",
  {
    ...
    },
    {
      channel = "capability",
      direction = "send",
      message = mock_parent_device:generate_test_message("main01", capabilities.switch.switch.off())
    },
  }, {
  ...
  {
    {
      channel = "zigbee",
      direction = "receive",
      message = { mock_parent_device.id, zcl_clusters.TuyaEF00.commands.DataReport:build_test_rx(mock_parent_device, { { 2, tuya_types.Int32(500) } }) }
    },
    {
      channel = "capability",
      direction = "send",
...
test.register_message_test(
  "To zigbee (DP 2) - switch level (mod)",
  {
    ...
    },
    {
      channel = "zigbee",
      direction = "send",
      message = { mock_parent_device.id, zcl_clusters.TuyaEF00.commands.DataRequest(mock_parent_device, { { 2, tuya_types.Int32(250) } }) }
    },
  }, {
    test_init = test_init_mod
  }
  ...
  {
    {
      channel = "zigbee",
      direction = "receive",
      message = { mock_parent_device.id, zcl_clusters.TuyaEF00.commands.DataReport:build_test_rx(mock_parent_device, { { 8, tuya_types.Int32(1000) } }) }
    },
    {
      channel = "capability",
      direction = "send",
  ...
  {
    {
      channel = "zigbee",
      direction = "receive",
      message = { mock_parent_device.id, zcl_clusters.TuyaEF00.commands.DataReport:build_test_rx(mock_parent_device, { { 8, tuya_types.Int32(500) } }) }
    },
    {
      channel = "capability",
      direction = "send",
...
test.register_message_test(
  "To zigbee (DP 8) - switch level (mod)",
  {
    ...
    },
    {
      channel = "zigbee",
      direction = "send",
      message = { mock_parent_device.id, zcl_clusters.TuyaEF00.commands.DataRequest(mock_parent_device, { { 8, tuya_types.Int32(250) } }) }
    },
  }, {
    test_init = test_init_mod
  }
