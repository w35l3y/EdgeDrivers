...
test.register_coroutine_test("profiles", function ()
  ...
  assert(myutils.is_same_profile({preferences={profile="other", manufacturer="manufaturer"}}, "profile", "manufacturer"), "1 True - Same manufacturer")
  ...
  assert(myutils.is_same_profile({preferences={profile="profile", manufacturer="manufaturer"}}, "profile", "manufacturer"), "2 True - Same manufacturer")
