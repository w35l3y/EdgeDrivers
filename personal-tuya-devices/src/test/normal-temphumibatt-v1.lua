...
local profile = t_utils.get_profile_definition("normal-temphumibatt-v1.yaml")
  ...
  {
    {
      ...
      message = mock_parent_device:generate_info_changed({
        preferences = {
          profile = "normal_temphumibatt_v1",
          tempOffset = -2.0,
          humidityOffset = 3.0,
          timezoneOffset = 0,
        }
    ...
    },
    {
      channel = "zigbee",
      direction = "receive",
      message = { mock_parent_device.id, zcl_clusters.TuyaEF00.commands.DataReport:build_test_rx(mock_parent_device, { { 1, tuya_types.Int32(250) } }) }
    },
    {
      channel = "capability",
      direction = "send",
    ...
    },
    {
      channel = "zigbee",
      direction = "receive",
      message = { mock_parent_device.id, zcl_clusters.TuyaEF00.commands.DataReport:build_test_rx(mock_parent_device, { { 2, tuya_types.Int32(75) } }) }
    },
    {
      channel = "capability",
      direction = "send",
